...
## Las cosas que puede hacer pegasus son:
* Espiar SMS
* Espiar correos electronicos
* Espiar aplicaciones de mensajeria instantanea
* Espiar el historial del navegador
Y se puede ejecutar en
* iOS
* Android
* Symbian
* BlackBerry
